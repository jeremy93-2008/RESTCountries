...
export function Detail() {
    ...
    const country = useMemo(() => {
        if (response.data) {
            return response.data.find((country) => country.name === name)
        }
    }, [response.data, name])
            ...
            <main className="px-14 py-14">
                <nav className="flex items-center justify-between pr-14">
                    <Link to="/">
                        ...
                        dark:bg-element-dark dark:text-white dark:shadow-gray-900"
                        >
                            <FaArrowLeft />
                ...
                <section className="flex mt-16">
                    {country && (
                        <>
                            ...
                            <div className="flex-1 max-w-[50vw] px-14 py-12">
